...
Executables live here — compiled binaries and runnable commands, installed and owned by the user. Source `.py` tools live in `../SCRIPTS/`. This README keeps the empty shelf alive through packaging.
