...
> **doc size = 25 KB → DISTILL triggered** — run `AGENTS/PROTOCOLS/OVERSEER/OV_DISTILL.md`; section caps govern below the threshold.

---

## Working Notes

- New seat requested → load `AGENTS/PROTOCOLS/OVERSEER/BUILD/NEW_AGENT.md` and run it with the user — never build a boot freehand.
- Cron work (staging, verifying) → load the manual first: `../OPERATOR_WORKSPACE/CRONS/README.md`; LOGS and HEALTH are script-owned, read-only.
