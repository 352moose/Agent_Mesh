...
> Information the Director needs for the next step — flags, recommendations, scope observations, and bugs found: a quest has no BUGS.md, so bugs are listed HERE, one line each. This is CLIde's channel to the Director.

```markdown
## Director Notes

- {note for Director}
- Bugs: {one line each, or none}
```

### Refs

> Key paths and references for this step.
...
| SCRATCHPAD | BUILD/SCRATCHPAD.md |
```
