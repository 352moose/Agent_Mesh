...
seat without needing to be told to do so. They all run the same
...
here by an agent; a scheduled job — one the Overseer sets up on its
first day — moves the flagged files to the trash later, which means
