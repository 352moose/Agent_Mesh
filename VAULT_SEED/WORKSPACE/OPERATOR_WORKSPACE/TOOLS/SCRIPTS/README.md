...
Python tools store here — `.py` files staged by agents, installed and owned by the user. Cron-driven scripts live in `../../CRONS/SCRIPTS/`, not here. This README keeps the empty shelf alive through packaging.
