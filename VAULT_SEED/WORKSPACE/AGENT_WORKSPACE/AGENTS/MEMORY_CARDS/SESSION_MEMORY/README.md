...
> Each seat's live session notebook, one folder per seat. Notebook discipline lives in each file's own rule table; this README carries the tier's bundled tour stop.
