...
- ACTIVE card section caps — standing decisions and in-flight state, not history
- Project STATE carry-forward: the next session needs the destination, never the path
