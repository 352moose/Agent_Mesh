...
created: 2026/08/08
updated: 2026/08/08
status: Draft — promote after the Overseer has reviewed one live run
---
...
| Parent  | OVERSEER                                                                 |
| Spawned | during a cascade, at the fan-out step of `../../PROTOCOLS/OVERSEER/Cascade_fan_out.md` |
