...
> Reusable scaffold for any permanent, overwrite-in-place workspace document. Copy this template, fill in the placeholders, delete sections that don't apply.
...
---
type: living_doc
scope:             # agent role | project name | system
maintained_by:     # agent role(s) who write this doc
updated:           # YYYY/MM/DD
session:           # S[N] or [ROLE] S[N]
